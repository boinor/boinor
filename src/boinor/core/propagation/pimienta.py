...
from boinor.core.angles import E_to_M, E_to_nu, nu_to_E
...
def pimienta_coe(k, p, ecc, inc, raan, argp, nu, tof):
    ...
    f7 = 32432400 * c15 * x_bar8 + 8648640 * c13 * x_bar6 + 1663200 * c11 * x_bar4 + 181440 * c9 * x_bar2 + 5040 * c7
    f8 = 259459200 * c15 * x_bar7 + 51891840 * c13 * x_bar5 + 6652800 * c11 * x_bar3 + 362880 * c9 * x_bar
    f9 = 1.8162144e9 * c15 * x_bar6 + 259459200 * c13 * x_bar4 + 19958400 * c11 * x_bar2 + 362880 * c9
    f10 = 1.08972864e10 * c15 * x_bar5 + 1.0378368e9 * c13 * x_bar3 + 39916800 * c11 * x_bar
